...
// 7) Use map to map the products array to its corresponding prices

// const prods=productsz.map((p)=>{
//     return p.product
// })
// const price=productsz.map((pr)=>{
//     return pr.price
// })
...
// const filteredCountry2=countries.filter((country)=>{
//    return  country.length ===6
// })

// console.log(filteredCountry2)

// 16) Declare a function called getStringLists which takes an array as a parameter and then returns an array only with string items.

// function getStringLists(array) {
//     // Filter out only the string items from the input array
//     const stringItems = array.filter((item) => typeof item === 'string');
//     return stringItems;
//   }

//   // Example usage:
//   const mixedArray = [1, 'hello', true, 'world', 42, 'openAI'];
//   const stringItemsArray = getStringLists(mixedArray);
//   console.log(stringItemsArray);

// 18) Use reduce to concatenate all the countries and to produce this sentence:
//  Estonia, Finland, Sweden, Denmark, Norway, and IceLand are north European countries

// const concatenatedCountries = countries.reduce((sentence, country, index) => {
...
// const totalPrice = productsz.reduce((acc, cur) => {
...
// const newObj=countries2.sort((a,b)=> {
//     return a.name.localeCompare(b.name) && a.capital.localeCompare(b.capital) && a.population - b.population
// })
...
// function mostPopulatedCountries(countries2, count){

//     const newObjArr = countries2
//     .map((obj) => {
//         return { country: obj.name, population: obj.population };
//     })
//     .sort((a, b) => b.population - a.population)
//     .filter((ele,index)=> index < count)
//     return newObjArr
// }
...
//     },
//     min: function(){
//         return ages.reduce((acc,cur)=>Math.min(acc,cur))
//     },
//     max: function(){
//         return ages.reduce((acc,cur)=>Math.max(acc,cur))
//     }
// }
// console.log('Count:', stat.count())
// console.log('Count:', stat.sum())
// console.log('Count:', stat.min())
// console.log('Count:', stat.max())